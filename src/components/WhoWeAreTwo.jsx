...
const WhoWeAreTwo = (props) => {
  ...
  return (
    <section className="relative md:py-24 py-16 bg-white dark:bg-slate-800 md:pt-0 pt-0 mt-20">
    ...
    <div className="absolute bottom-0 left-0 right-0 sm:h-2/3 h-4/5 bg-gradient-to-b from-indigo-500 to-indigo-600" />
  </section>
  )
}
